...
def se_densenet(growthRate=32, head7x7=True, dropRate=0,
    ...
    """
    model = SEDenseNet(growthRate=growthRate, head7x7=head7x7, dropRate=dropRate,
...
def se_densenet121_g32():
    model = SEDenseNet(bottleneck=True, growthRate=32, head7x7=True, dropRate=0,
...
def se_densenet161_g48():
    model = SEDenseNet(bottleneck=True, growthRate=48, head7x7=True, dropRate=0,
...
def se_densenet121_g8i2():
    model = SEDenseNet(bottleneck=True, growthRate=8, head7x7=True, dropRate=0,
...
def se_densenet264_g12i2():
    model = SEDenseNet(bottleneck=True, growthRate=12, head7x7=True, dropRate=0,
